...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	<head>
		...
		<title>Bolegweb Web Feature Services Harvesting Jobs Script Monitor</title>
		...
		<script>
			...
			function vec()
			{
				document.location.href = 'harvesting-pycsw-wfs.php';
			}
		</script>
	...
	<body onload="refresh()">
		...
		<div id="content">
			<?php 
				...
				$q = dbq("SELECT * FROM services WHERE type='wfs' AND (version='2.0.0' OR version='1.1.0' OR version='1.0.0') AND harvest_file IS NOT NULL AND status=1 AND harvested=0 ORDER BY id ASC LIMIT 1");				
